...
export default function CRUDProducts(){
    ...
    const handleCreate = (product) =>{
        ...
        axios.post(`https://${process.env.REACT_APP_API_URL}/products`, product)
        .then(({data}) => {
            setState({
    ...
    function deletedProduct(id){
        ...
        axios.delete(`https://${process.env.REACT_APP_API_URL}/products/${id}`)
        .then(({data}) =>{
    ...
    const updateProduct = (id, product) =>{
        ...
        //y Su id
        axios.put(`https://${process.env.REACT_APP_API_URL}/products/${id}`, product)
        .then(({data}) => setState({
