...
export default function MercadoPago(){
    ...
    window.Mercadopago.setPublishableKey("TEST-a90f4f4e-0dd9-4de5-b855-e2de1f7c9abc");
    ...
    return (
        <>
            <form action="/process_payment" method="post" id="paymentForm" onSubmit={onSubmit}>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="cardNumber" data-checkout="cardNumber"
                            onselectstart="return false" onpaste="return false"
                            oncopy="return false" oncut="return false"
                            ondrag="return false" ondrop="return false" autocomplete="off" onChange={change} />
                    </div>
                    <div>
